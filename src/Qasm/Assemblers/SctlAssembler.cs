...
{
    public class SctlAssembler : AbstractAssembler
    {

        public SctlAssembler()
            : base(new string[] { "sctl" })
        {
        }
        ...
        public override void Assemble(CodeGenerator cgen, Instruction ins, BytecodeStream str)
        {
            ...
            else
            {
                ...
                str.Emit(new QuasarInstruction(Opcode.SCTL, new RegisterOperand(dest.Register)));
