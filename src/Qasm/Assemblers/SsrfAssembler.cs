...
{
    public class SsrfAssembler : AbstractAssembler
    {

        public SsrfAssembler()
            : base(new string[] { "ssrf" })
        {
        }
        ...
        public override void Assemble(CodeGenerator cgen, Instruction ins, BytecodeStream str)
        {
            ...
            else
            {
                ...
                str.Emit(new QuasarInstruction(Opcode.SSRF, new RegisterOperand(dest.Register)));
