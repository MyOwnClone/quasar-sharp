...
{
    public class LsrfAssembler : AbstractAssembler
    {

        public LsrfAssembler()
            : base(new string[] { "lsrf" })
        {
        }
        ...
        public override void Assemble(CodeGenerator cgen, Instruction ins, BytecodeStream str)
        {
            ...
            else
            {
                ...
                str.Emit(new QuasarInstruction(Opcode.LSRF, new RegisterOperand(src.Register)));
