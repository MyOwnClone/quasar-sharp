...
{
    public class LurfAssembler : AbstractAssembler
    {

        public LurfAssembler()
            : base(new string[] { "lurf" })
        {
        }
        ...
        public override void Assemble(CodeGenerator cgen, Instruction ins, BytecodeStream str)
        {
            ...
            else
            {
                ...
                str.Emit(new QuasarInstruction(Opcode.LURF, new RegisterOperand(src.Register)));
