...
{
    public class DivAssembler : AbstractAssembler
    {
    ...
    public class IDivAssembler : AbstractAssembler
    {

        public IDivAssembler()
            : base(new string[] { "idiv" })
        {
        }
