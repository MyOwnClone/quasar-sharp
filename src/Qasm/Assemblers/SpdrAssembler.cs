...
{
    public class SpdrAssembler : AbstractAssembler
    {

        public SpdrAssembler()
            : base(new string[] { "spdr" })
        {
        }
        ...
        public override void Assemble(CodeGenerator cgen, Instruction ins, BytecodeStream str)
        {
            ...
            else
            {
                ...
                str.Emit(new QuasarInstruction(Opcode.SPDR, new RegisterOperand(dest.Register)));
